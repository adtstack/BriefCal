...
| [ADR-019](ADR-019-local-only-no-ai-no-product-cloud.md) | Accepted | 이 Mac에서만 실행하는 무AI·무BriefCal Cloud 제품 경계 |
| [ADR-020](ADR-020-signed-automatic-updates.md) | Accepted | 서명된 direct-download 자동업데이트 |
| [ADR-021](ADR-021-briefcal-pre-release-identity-baseline.md) | Accepted | BriefCal 미출시 제품 식별자 기준선 |
