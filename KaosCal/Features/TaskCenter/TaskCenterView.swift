    ...
    var body: some View {
        HStack(alignment: .top, spacing: 10) {
            ...
            Button {
                ...
                Image(
                    systemName: item.planning.isImportant
                        ? "star.fill"
                        : "star"
                )
            }
            .buttonStyle(.plain)
            .foregroundStyle(
                item.planning.isImportant ? Color.orange : Color.secondary
            )
            .help(item.planning.isImportant ? "Remove important" : "Mark important")
            .accessibilityLabel(
                item.planning.isImportant ? "Remove important" : "Mark important"
            )
            ...
            .buttonStyle(.plain)
            .foregroundStyle(.secondary)
            .help("Priority, repeat, checklist, and time")
            .accessibilityLabel("Edit task planning")
        ...
        VStack(spacing: 0) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    Label(
                        "Priority, repeat, checklist, and time stay in KaosCal on this Mac. Only common title, completion, and due fields use the provider sync route.",
