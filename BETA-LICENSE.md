...
- legal publisher name and jurisdiction;
- support, privacy, and security contact routes;
- permitted beta users, duration, devices, feedback and termination terms;
- warranty, liability, refund and update terms appropriate to the chosen distribution model;
- final license-provider and purchase/activation behavior, if any;
- review of `PRIVACY.md`, `SECURITY.md`, and third-party notices for the exact artifact.
