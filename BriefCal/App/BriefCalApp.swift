...
private struct BriefCalCommands: Commands {
...
private struct BriefCalRootView: View {
...
#if DEBUG || BRIEFCAL_LOCAL_TEST_BUILD
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            onboardingRow(
                ...
                detail: "BriefCal never asks for your Exchange password or MFA code. Full Calendar access is requested by macOS after this introduction."
            )
            onboardingRow(
                icon: "checklist",
        ...
        do {
            ...
            return AppState(
                ...
                calendarProvider: UITestCalendarProvider(
                    scenarioName: environment["BRIEFCAL_UI_TEST_SCENARIO"]
                ),
                contextStore: contextStore,
                localContextStoreState: .ready
            )
