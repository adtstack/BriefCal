...
struct CalendarEventMutationPartialSuccess: LocalizedError {
    ...
    var errorDescription: String? {
        "The calendar event was saved, but BriefCal could not identify the post-save occurrence. Do not retry this change. Reload and review it in Calendar.app; any local Event Brief was kept."
    }
}
...
extension CalendarEventWriteError: LocalizedError {
    var errorDescription: String? {
        ...
        case .ambiguousEvent:
            "BriefCal found more than one strong event match and did not change any event."
        case .eventChangedExternally:
            "The event changed outside BriefCal. Reopen the editor to review the latest version."
        case .emptyTitle:
        ...
        case .unsupportedRecurrence:
            "This recurrence rule is too complex to change safely in BriefCal. Use Calendar.app for recurrence changes."
        case .recurrenceChangeRequiresFutureScope:
        ...
        case .detachedFutureScopeUnsupported:
            "BriefCal cannot safely apply future changes from a detached occurrence. Use Calendar.app."
        }
    }
}
