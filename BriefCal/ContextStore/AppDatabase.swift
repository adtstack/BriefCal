...
struct AppDatabase: Sendable {
    ...
    static func defaultDatabaseURL(
        ...
        return directory.appendingPathComponent("briefcal.sqlite")
    }
    ...
    func restoreSnapshot(from fileURL: URL) throws {
        ...
        configuration.label = "BriefCal Validated Restore Source"
    ...
    private static func makeConfiguration() -> Configuration {
        ...
        configuration.label = "BriefCal Context Store"
